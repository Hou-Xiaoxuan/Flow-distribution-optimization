 ...
 */
#include "sa.h"
SOLVE_SA::SOLVE_SA(Data data) : data(data)
{
    /* 初始化随机种子 */
    srand(time(NULL));
...
void SOLVE_SA::excute_sa(double T, double dT, double end_T)
{
        ...
        if (is_accept == true)
        {
            ...
            else
            {
                ...
                if (site_to.old_flow == this->specific_flow[site_to.site]._96)
                {
                    ...
                    this->specific_flow[site_to.site]._96 = this->tree[site_to.site].queryK(this->specific_index._96);
                }
