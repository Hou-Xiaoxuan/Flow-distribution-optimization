 ...
 * @Description:
 * @LastEditors: LinXuan
 * @LastEditTime: 2022-04-03 16:43:22
...
struct Data {
    ...
    // 一些工具函数
    inline size_t get_customer_num() const { return this->customer_site.size(); }
    inline size_t get_edge_num() const { return this->edge_site.size(); }
    inline size_t get_mtime_num() const { return this->demand.size(); }
};
Data read_file();
